    ...
    public class SkillMenu
    {
        ...
        public virtual void Update()
        {
            if (active)
            {
                ...
                {
                    hero.skillBar.slots[0].skillButton = new SkillButon("2d\\Misc\\solid", new Vector2(0,0), new Vector2(40,40), hero.SetSkill, selectedSkill);

                }

                if (Globals.keyboard.GetSinglePress("D2"))
                {
                    hero.skillBar.slots[1].skillButton = new SkillButon("2d\\Misc\\solid", new Vector2(0, 0), new Vector2(40, 40), hero.SetSkill, selectedSkill);

                }
                if (Globals.keyboard.GetSinglePress("D3"))
                {
                    hero.skillBar.slots[2].skillButton = new SkillButon("2d\\Misc\\solid", new Vector2(0, 0), new Vector2(40, 40), hero.SetSkill, selectedSkill);

                }
                if (Globals.keyboard.GetSinglePress("D4"))
                {
                    hero.skillBar.slots[3].skillButton = new SkillButon("2d\\Misc\\solid", new Vector2(0, 0), new Vector2(40, 40), hero.SetSkill, selectedSkill);
